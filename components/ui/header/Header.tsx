...
export const Header = () => {
  ...
  return (
    ...
    >
      <div
        className={`absolute w-full inset-0 bg-background-muted/95 ease-linear h-screen transition-transform duration-[${ANIM_MS}ms] ${
          isOpen
            ? "translate-y-0"
            : "pointer-events-none delay-150 -translate-y-[85vh]"
        }`}
      />
      {/* Logo */}
